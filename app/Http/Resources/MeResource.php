...
class MeResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        if ($this->profile_type === 'App\Models\Aluno') {
            $aluno = Aluno::where('id', $this->profile_id)->first();
            $feedback = Feedback::findOrFail($aluno->current_feedback_id);
            return [
                'id' => $this->id,
                'aluno_id' => $this->profile_id,
                'name' => $this->name,
                ...
                'current_feedback_id' => $aluno->current_feedback_id,
                'status_feedback' => $feedback->is_aprovado ? 'aprovado' : 'pendente',
